        ...
        <div>
            <form method="post" action="Creation?type=Cours">
                <fieldset>
                    ...
                    <input type="text" id="Salle" name="Salle" value="" size="20" maxlength="100" />
                    <br />

                    <label for="Intervenant">Intervenant </label>
                    <input type="text" id="Intervenant" name="Intervenant" value="" size="20" maxlength="100" />
                    <br />

                    <label for="Commentaire">Commentaire </label>
                    <input type="text" id="Commentaire" name="Commentaire" value="" size="20" maxlength="100" />
                    <br />
